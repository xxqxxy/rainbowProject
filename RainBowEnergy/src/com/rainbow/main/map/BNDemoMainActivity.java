...
public class BNDemoMainActivity extends Activity {
	...
	private void routeplanToNavi(CoordinateType coType) {
        ...
        switch (coType) {
            ...
            case BD09LL: {
                sNode = new BNRoutePlanNode(120.20784537597782, 30.057009624099436, "滨江区", null, coType);
                eNode = new BNRoutePlanNode(120.20386525193937, 30.915160800132085, "拱墅区", null, coType);
                break;
            }
            default:
                ;
