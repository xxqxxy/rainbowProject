 ...
 * @author Leszek Wach
 */
public abstract class AbstractChartView extends View implements Chart,Runnable{
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        ...
        chartComputator.setContentRect(getWidth(), getHeight(), getPaddingLeft(), getPaddingTop(), getPaddingRight()+20,
                getPaddingBottom()+20);
